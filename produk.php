								  ...
								  <?php
									...
									<div class="col-md-3"  style="border:1px solid #000;border-radius:12px; padding:10px; margin:10px;">
										<span class="thumbnail">
											<img src="<?php $data['gambar']==''?print("./gambar/default.png"):print("./upload/".$data['gambar']); ?>" style="max-width:100%;height:240px;">
										</span>
											<div class="row">
												<div class="col-md-4">
											...
											<span class="input-group-btn" style="text-align:right">
													<div class="w3-container" data-toggle="modal" data-target=".<?php echo $data['id_produk'];?>">
													<input id="id_produk" type="hidden" name="id_produk" />
														<button class="btn btn-primary btn-md">Edit</button>
													</div>
													<form method="POST" action="modul/deleteproduk.php" onclick="javascript: return confirm('Anda yakin hapus ?')">
														<input id="id_produk" type="hidden" name="id_produk" value="<?php echo $data['id_produk'];?>" />
														<button class="btn btn-danger btn-md" name="action" type="submit">Hapus</button>
													</form>
											</span>
									</div>
									<div class="modal fade <?php echo $data['id_produk'];?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
													  ...
													  <div class="panel-body">
														<form action="./modul/editproduk.php" method="post" enctype="multipart/form-data">
															<div class="form-group">
																...
																<input type="text" maxlength="14" class="validate" id="nama_produk" placeholder="Nama Produk" name="nama_produk" value="<?php echo $data['nama_produk'];?>" required>
															</div>
															<div class="form-group">
																<label for="pwd" >Harga Produk :</label>
																<input type="number" maxlength="14" class="validate" id="harga_produk" placeholder="Harga Produk" name="harga_produk" value="<?php echo $data['harga_produk'];?>" required>
															</div>
																<span class="thumbnail">
																	<img src="<?php $data['gambar']==''?print("./gambar/default.png"):print("./upload/".$data['gambar']); ?>" style="max-width:100%;height:240px;">
																</span>
